...
#ifndef __stream_mul_32s_18qcK__HH__
#define __stream_mul_32s_18qcK__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(stream_mul_32s_18qcK) {
    ...
    SC_CTOR(stream_mul_32s_18qcK):  ACMP_mul_su_U ("ACMP_mul_su_U") {
