...
#ifndef __stream_mul_32s_26pcA__HH__
#define __stream_mul_32s_26pcA__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(stream_mul_32s_26pcA) {
    ...
    SC_CTOR(stream_mul_32s_26pcA):  ACMP_mul_su_U ("ACMP_mul_su_U") {
