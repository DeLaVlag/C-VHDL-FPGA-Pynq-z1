...
(* CORE_GENERATION_INFO="stream,hls_ip_2017_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=5.169000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=273,HLS_SYN_LUT=908}" *)
...
wire   [31:0] tmp_data_V_fu_173_p3;
wire   [0:0] y_flag_1_fu_194_p2;
reg    ap_block_pp0_stage0_subdone;
wire   [15:0] y_new_1_fu_200_p3;
wire   [15:0] x_new_fu_222_p3;
reg    ap_block_pp0_stage0_01001;
wire   [15:0] p_y_load_fu_159_p3;
wire   [0:0] tmp_7_fu_167_p2;
wire   [15:0] tmp_s_fu_182_p2;
wire   [0:0] tmp_fu_216_p2;
wire   [15:0] tmp_3_fu_208_p3;
wire   [15:0] x_load_op_fu_188_p2;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((2'd3 == src_V_keep_V_0_state) & (1'b0 == src_V_keep_V_0_vld_in) & (1'b1 == src_V_keep_V_0_ack_out)) | ((2'd2 == src_V_keep_V_0_state) & (1'b0 == src_V_keep_V_0_vld_in)))) begin
        ...
        end else if ((((2'd1 == src_V_keep_V_0_state) & (1'b1 == src_V_keep_V_0_ack_out)) | ((2'd2 == src_V_keep_V_0_state) & (1'b1 == src_V_keep_V_0_vld_in)) | (~((1'b0 == src_V_keep_V_0_vld_in) & (1'b1 == src_V_keep_V_0_ack_out)) & ~((1'b0 == src_V_keep_V_0_ack_out) & (1'b1 == src_V_keep_V_0_vld_in)) & (2'd3 == src_V_keep_V_0_state)))) begin
...
always @ (posedge ap_clk) begin
    if (((ap_block_pp0_stage0_11001 == 1'b0) & (1'd1 == y_flag_1_fu_194_p2) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        y <= y_new_1_fu_200_p3;
    end
end

always @ (*) begin
    if (((1'b0 == 1'b1) & (1'b0 == ap_enable_reg_pp0_iter2) & (1'b0 == ap_enable_reg_pp0_iter1))) begin
        ap_idle_pp0 = 1'b1;
    end else begin
        ap_idle_pp0 = 1'b0;
    end
...
always @ (*) begin
    if ((((ap_block_pp0_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter2)) | ((ap_block_pp0_stage0 == 1'b0) & (1'b1 == ap_enable_reg_pp0_iter1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == dst_V_dest_V_1_ack_in) | (1'b0 == dst_V_id_V_1_ack_in) | (1'b0 == dst_V_last_V_1_ack_in) | (1'b0 == dst_V_user_V_1_ack_in) | (1'b0 == dst_V_strb_V_1_ack_in) | (1'b0 == dst_V_keep_V_1_ack_in) | (1'b0 == dst_V_data_V_1_ack_in))) | ((1'b0 == src_V_data_V_0_vld_out) & (1'b1 == ap_enable_reg_pp0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == dst_V_dest_V_1_ack_in) | (1'b0 == dst_V_id_V_1_ack_in) | (1'b0 == dst_V_last_V_1_ack_in) | (1'b0 == dst_V_user_V_1_ack_in) | (1'b0 == dst_V_strb_V_1_ack_in) | (1'b0 == dst_V_keep_V_1_ack_in) | (1'b0 == dst_V_data_V_1_ack_in))) | ((1'b1 == ap_enable_reg_pp0_iter1) & ((1'b0 == dst_V_data_V_1_ack_in) | (1'b0 == src_V_data_V_0_vld_out))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_enable_reg_pp0_iter2) & ((1'b0 == dst_V_dest_V_1_ack_in) | (1'b0 == dst_V_id_V_1_ack_in) | (1'b0 == dst_V_last_V_1_ack_in) | (1'b0 == dst_V_user_V_1_ack_in) | (1'b0 == dst_V_strb_V_1_ack_in) | (1'b0 == dst_V_keep_V_1_ack_in) | (1'b0 == dst_V_data_V_1_ack_in))) | ((1'b1 == ap_enable_reg_pp0_iter1) & ((1'b0 == dst_V_data_V_1_ack_in) | (1'b0 == src_V_data_V_0_vld_out))));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (1'b0 == src_V_data_V_0_vld_out);
end

always @ (*) begin
    ap_block_state3_pp0_stage0_iter2 = ((1'b0 == dst_V_dest_V_1_ack_in) | (1'b0 == dst_V_id_V_1_ack_in) | (1'b0 == dst_V_last_V_1_ack_in) | (1'b0 == dst_V_user_V_1_ack_in) | (1'b0 == dst_V_strb_V_1_ack_in) | (1'b0 == dst_V_keep_V_1_ack_in) | (1'b0 == dst_V_data_V_1_ack_in));
end
...
assign p_y_load_fu_159_p3 = ((src_V_user_V_0_data_out[0:0] === 1'b1) ? 16'd0 : y);
...
assign tmp_3_fu_208_p3 = ((src_V_last_V_0_data_out[0:0] === 1'b1) ? 16'd0 : 16'd1);

assign tmp_7_fu_167_p2 = ((p_y_load_fu_159_p3 == 16'd0) ? 1'b1 : 1'b0);

assign tmp_data_V_fu_173_p3 = ((tmp_7_fu_167_p2[0:0] === 1'b1) ? 32'd50 : 32'd0);

assign tmp_fu_216_p2 = (src_V_user_V_0_data_out | src_V_last_V_0_data_out);

assign tmp_s_fu_182_p2 = (p_y_load_fu_159_p3 + 16'd1);

assign x_load_op_fu_188_p2 = (x + 16'd1);

assign x_new_fu_222_p3 = ((tmp_fu_216_p2[0:0] === 1'b1) ? tmp_3_fu_208_p3 : x_load_op_fu_188_p2);

assign y_flag_1_fu_194_p2 = (src_V_user_V_0_data_out | src_V_last_V_0_data_out);

assign y_new_1_fu_200_p3 = ((src_V_last_V_0_data_out[0:0] === 1'b1) ? tmp_s_fu_182_p2 : 16'd0);
