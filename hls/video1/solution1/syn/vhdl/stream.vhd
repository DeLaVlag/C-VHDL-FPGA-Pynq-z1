...
architecture behav of stream is 
    ...
    "stream,hls_ip_2017_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg400-1,HLS_INPUT_CLOCK=7.000000,HLS_INPUT_ARCH=pipeline,HLS_SYN_CLOCK=5.169000,HLS_SYN_LAT=2,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=273,HLS_SYN_LUT=908}";
    ...
    signal tmp_data_V_fu_173_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal y_flag_1_fu_194_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal y_new_1_fu_200_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal x_new_fu_222_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal p_y_load_fu_159_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_7_fu_167_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_s_fu_182_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_fu_216_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_208_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal x_load_op_fu_188_p2 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if ((((ap_const_lv2_3 = src_V_keep_V_0_state) and (ap_const_logic_0 = src_V_keep_V_0_vld_in) and (ap_const_logic_1 = src_V_keep_V_0_ack_out)) or ((ap_const_lv2_2 = src_V_keep_V_0_state) and (ap_const_logic_0 = src_V_keep_V_0_vld_in)))) then 
                ...
                elsif ((((ap_const_lv2_1 = src_V_keep_V_0_state) and (ap_const_logic_1 = src_V_keep_V_0_ack_out)) or ((ap_const_lv2_2 = src_V_keep_V_0_state) and (ap_const_logic_1 = src_V_keep_V_0_vld_in)) or (not(((ap_const_logic_0 = src_V_keep_V_0_vld_in) and (ap_const_logic_1 = src_V_keep_V_0_ack_out))) and not(((ap_const_logic_0 = src_V_keep_V_0_ack_out) and (ap_const_logic_1 = src_V_keep_V_0_vld_in))) and (ap_const_lv2_3 = src_V_keep_V_0_state)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = dst_V_data_V_1_load_A)) then
                dst_V_data_V_1_payload_A <= tmp_data_V_fu_173_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = dst_V_data_V_1_load_B)) then
                dst_V_data_V_1_payload_B <= tmp_data_V_fu_173_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_block_pp0_stage0_11001 = ap_const_boolean_0) and (ap_const_lv1_1 = y_flag_1_fu_194_p2) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                y <= y_new_1_fu_200_p3;
            end if;
        end if;
    end process;
    ...
    begin
                ap_block_pp0_stage0_01001 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = dst_V_dest_V_1_ack_in) or (ap_const_logic_0 = dst_V_id_V_1_ack_in) or (ap_const_logic_0 = dst_V_last_V_1_ack_in) or (ap_const_logic_0 = dst_V_user_V_1_ack_in) or (ap_const_logic_0 = dst_V_strb_V_1_ack_in) or (ap_const_logic_0 = dst_V_keep_V_1_ack_in) or (ap_const_logic_0 = dst_V_data_V_1_ack_in))) or ((ap_const_logic_0 = src_V_data_V_0_vld_out) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1)));
    end process;
    ...
    begin
                ap_block_pp0_stage0_11001 <= (((ap_const_logic_1 = ap_enable_reg_pp0_iter2) and ((ap_const_logic_0 = dst_V_dest_V_1_ack_in) or (ap_const_logic_0 = dst_V_id_V_1_ack_in) or (ap_const_logic_0 = dst_V_last_V_1_ack_in) or (ap_const_logic_0 = dst_V_user_V_1_ack_in) or (ap_const_logic_0 = dst_V_strb_V_1_ack_in) or (ap_const_logic_0 = dst_V_keep_V_1_ack_in) or (ap_const_logic_0 = dst_V_data_V_1_ack_in))) or ((ap_const_logic_1 = ap_enable_reg_pp0_iter1) and ((ap_const_logic_0 = dst_V_data_V_1_ack_in) or (ap_const_logic_0 = src_V_data_V_0_vld_out))));
    end process;
    ...
    begin
                ap_block_state2_pp0_stage0_iter1 <= (ap_const_logic_0 = src_V_data_V_0_vld_out);
    end process;
    ...
    begin
                ap_block_state3_pp0_stage0_iter2 <= ((ap_const_logic_0 = dst_V_dest_V_1_ack_in) or (ap_const_logic_0 = dst_V_id_V_1_ack_in) or (ap_const_logic_0 = dst_V_last_V_1_ack_in) or (ap_const_logic_0 = dst_V_user_V_1_ack_in) or (ap_const_logic_0 = dst_V_strb_V_1_ack_in) or (ap_const_logic_0 = dst_V_keep_V_1_ack_in) or (ap_const_logic_0 = dst_V_data_V_1_ack_in));
    end process;
    ...
    begin
        if (((ap_const_logic_0 = ap_const_logic_1) and (ap_const_logic_0 = ap_enable_reg_pp0_iter2) and (ap_const_logic_0 = ap_enable_reg_pp0_iter1))) then 
    ...
    begin
        if ((((ap_block_pp0_stage0 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter2)) or ((ap_block_pp0_stage0 = ap_const_boolean_0) and (ap_const_logic_1 = ap_enable_reg_pp0_iter1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0)))) then 
    ...
    tmp_3_fu_208_p3 <= 
        ...
        ap_const_lv16_1;
    tmp_7_fu_167_p2 <= "1" when (p_y_load_fu_159_p3 = ap_const_lv16_0) else "0";
    tmp_data_V_fu_173_p3 <= 
        ap_const_lv32_32 when (tmp_7_fu_167_p2(0) = '1') else 
        ap_const_lv32_0;
    tmp_fu_216_p2 <= (src_V_user_V_0_data_out or src_V_last_V_0_data_out);
    tmp_s_fu_182_p2 <= std_logic_vector(unsigned(p_y_load_fu_159_p3) + unsigned(ap_const_lv16_1));
    x_load_op_fu_188_p2 <= std_logic_vector(unsigned(x) + unsigned(ap_const_lv16_1));
    x_new_fu_222_p3 <= 
        tmp_3_fu_208_p3 when (tmp_fu_216_p2(0) = '1') else 
        x_load_op_fu_188_p2;
    y_flag_1_fu_194_p2 <= (src_V_user_V_0_data_out or src_V_last_V_0_data_out);
    y_new_1_fu_200_p3 <= 
        tmp_s_fu_182_p2 when (src_V_last_V_0_data_out(0) = '1') else 
        ap_const_lv16_0;
end behav;
