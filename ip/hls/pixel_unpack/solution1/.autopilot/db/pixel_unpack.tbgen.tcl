set C_TypeInfoList {{ 
"pixel_unpack" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"in_stream": [[],{ "pointer": "0"}] }, {"out_stream": [[],{ "pointer": "1"}] }, {"mode": [[], {"scalar": "int"}] }],[],""], 
"0": [ "wide_stream", {"struct": [[],[],[{ "data": [[], "2"]},{ "user": [[], "3"]},{ "last": [[], "3"]}],""]}], 
"1": [ "narrow_stream", {"struct": [[],[],[{ "data": [[], "4"]},{ "user": [[], "3"]},{ "last": [[], "3"]}],""]}], 
...
set C_modelArgList {
	...
	{ out_stream_data_V int 24 regular {axi_s 1 volatile  { out_stream data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "in_stream_data_V", "interface" : "axis", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "in_stream.data.V","cData": "uint32","bit_use": { "low": 0,"up": 31},"cArray": [{"low" : 0,"up" : 23,"step" : 1}]}]}]} , 
 	...
 	{ "Name" : "out_stream_data_V", "interface" : "axis", "bitwidth" : 24, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":23,"cElement": [{"cName": "out_stream.data.V","cData": "uint24","bit_use": { "low": 0,"up": 23},"cArray": [{"low" : 0,"up" : 95,"step" : 1}]}]}]} , 
 	{ "Name" : "out_stream_user_V", "interface" : "axis", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "out_stream.user.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 95,"step" : 1}]}]}]} , 
 	{ "Name" : "out_stream_last_V", "interface" : "axis", "bitwidth" : 1, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "out_stream.last.V","cData": "uint1","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 95,"step" : 1}]}]}]} , 
...
set portList { 
	...
	{ out_stream_TDATA sc_out sc_lv 24 signal 3 } 
...
set NewPortList {[ 
	{ "name": "s_axi_AXILiteS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "AXILiteS", "role": "AWADDR" },"address":[{"name":"mode","role":"data","value":"16"}] },
	...
	{ "name": "ap_rst_n_control", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "reset", "bundle":{"name": "AXILiteS", "role": "axilite_rst" } }, 
 	...
 	{ "name": "out_stream_TDATA", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "out_stream_data_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"], "CDFG" : "pixel_unpack", "VariableLatency" : "1", "AlignedPipeline" : "0", "UnalignedPipeline" : "0", "ProcessNetwork" : "0", "Combinational" : "0", "ControlExist" : "0",
		"Port" : [
		...
		"WaitState" : [],
		"SubBlockPort" : []},
	{"Level" : "1", "Path" : "`AUTOTB_DUT_INST.pixel_unpack_AXILiteS_s_axi_U", "Parent" : "0", "Child" : []}]}
...
set Spec2ImplPortList { 
	in_stream_data_V { axis {  { in_stream_TDATA in_data 0 32 }  { in_stream_TVALID in_vld 0 1 } } }
	...
	out_stream_data_V { axis {  { out_stream_TDATA out_data 1 24 } } }
