...
#ifndef __color_convert_mul_8ns_10s_18_2__HH__
#define __color_convert_mul_8ns_10s_18_2__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(color_convert_mul_8ns_10s_18_2) {
    ...
    SC_CTOR(color_convert_mul_8ns_10s_18_2):  ACMP_mul_us_U ("ACMP_mul_us_U") {
