...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("in_data_TREADY", 1, hls_out, 2, "axis", "in_acc", 1),
	Port_Property("in_data_TUSER", 1, hls_in, 1, "axis", "in_data", 1),
	Port_Property("in_data_TLAST", 1, hls_in, 2, "axis", "in_data", 1),
	Port_Property("out_data_TDATA", 24, hls_out, 3, "axis", "out_data", 1),
	Port_Property("out_data_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("out_data_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
	Port_Property("out_data_TUSER", 1, hls_out, 4, "axis", "out_data", 1),
	Port_Property("out_data_TLAST", 1, hls_out, 5, "axis", "out_data", 1),
