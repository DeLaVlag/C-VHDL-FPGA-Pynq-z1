...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 l W 0x0 "Data signal of l" {{0 8 l W 0 "Bit 7 to 0 Data signal of l"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 c W 0x0 "Data signal of c" {{0 8 c W 0 "Bit 7 to 0 Data signal of c"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 r W 0x0 "Data signal of r" {{0 8 r W 0 "Bit 7 to 0 Data signal of r"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 7.000000 machine 64 combinational 0 latency 5 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/yoflippo/Documents/PYNQ_lab6/PYNQ/PYNQ/hls/video1/main.cpp}
if {$enable_xo_gen} {
